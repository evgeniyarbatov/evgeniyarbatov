...
I build tools and prototypes in Python and JavaScript/React along with Docker, Terraform, and API integrations. My work centers on geospatial data (OSM, GPX/TCX, routing) and visualization.

## Technologies I use
**Languages**: Python, TypeScript, JavaScript, Java <br>
